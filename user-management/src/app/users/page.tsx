        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-light text-slate-700 mb-2">
              {(() => {
                const title = searchTerm ? 'No matching users found' : 'No users found';
                return title;
              })()}
            </h3>
            <p className="text-slate-500 font-light">
              {(() => {
                const description = searchTerm ? 'Try adjusting your search terms' : 'Get started by creating your first user';
                return description;
              })()}
            </p>
          </div>
